<html>
<head>
<title>Inserting Student Grades</title>
...
<div class="container">
<div class="center">
<h1>INSERTING STUDENT GRADES</h1>
</head>
<body>
<?php
...
{
	echo "<h3>Searching for Student Grades in Database</h3>";
}
else
{
...
mysqli_close($conn);
header("refresh:5; url=list_student_grades.php");
?>
</div>
</div>
</body>
