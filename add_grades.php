...
<p>
<input type="number" name="modules_id" id="modules_id" placeholder="Module ID (Example: 1000, 4604, 3601, etc.)">
</p>
<p>
<input type="number" name="grades_result" id="grades_result" placeholder="Result (Example: 70, 80, 90, etc.)">
</p>
<br>
<br>
<input type="submit" class="button" value="ADD GRADE">
<br>
<br>
