<html>
<head>
<title>Inserting Grade Data</title>
...
$sql = "INSERT INTO grades VALUES ('$grades_id', '$students_id', '$modules_id', '$grades_result')";
if(mysqli_query($conn, $sql))
{
	echo "<h3>Grade Added to the Database Successfully</h3>";
}
else
{
